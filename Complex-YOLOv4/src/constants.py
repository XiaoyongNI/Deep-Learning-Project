...
base_dir_metric_fd = '../dataset/kitti/base_dir_metric_fd' # Directory that contains AP or AR values by the fine detector
base_dir_metric_cd = '../dataset/kitti/base_dir_metric_cd' # Directory that contains AP or AR values by the coarse detector
