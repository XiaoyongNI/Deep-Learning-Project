...
parser.add_argument('--cv_dir', default='../RLsave/regnet_', help='checkpoint directory (models and logs are saved here)')
parser.add_argument('--save_intervals',default = 10,help='At every N epoch save the checkpoint')
parser.add_argument('--epoch_step', type=int, default=10000, help='epochs after which lr is decayed')
parser.add_argument('--max_epochs', type=int, default=30, help='total epochs to run')
...
parser.add_argument('--model_type',type = str,default='regnet200mf',help='model type')
